...
public class GasStation {
    public int canCompleteCircuit(int[] gas, int[] cost) {
        ...
        for (int i = 0; i < totalStation; i++) {
            ...
            int stationIndex = nextStation(totalStation, i);
            for (int j = 0; j <= totalStation; j++) {
                ...
                stationIndex = nextStation(totalStation, stationIndex);
            }
            return i;
        }
    ...
    public int nextStation(int totalStation, int i) {
        int next = i + 1;
        return totalStation > next ? next : 0;
    }

    public static void main(String[] args) {
//[4,5,2,6,5,3]
//[3,2,7,3,2,9]
        System.out.println(new GasStation().canCompleteCircuit(new int[]{4,5,2,6,5,3}, new int[]{3,2,7,3,2,9}));
